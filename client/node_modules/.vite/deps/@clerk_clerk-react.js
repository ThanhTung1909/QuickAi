...
// node_modules/@clerk/clerk-react/dist/chunk-5OEED2TE.mjs
...
var useCheckout = (options) => {
  ...
  const manager = (0, import_react12.useMemo)(
  ...
  const managerProperties = (0, import_react12.useSyncExternalStore)(
    (cb) => manager.subscribe(cb),
    () => manager.getState(),
    () => manager.getState()
  );
  const properties = (0, import_react12.useMemo)(() => {
...
var PropsProvider = ({ children, ...props }) => {
  ...
  const [isPaymentElementReady, setIsPaymentElementReady] = (0, import_react13.useState)(false);
  return import_react14.default.createElement(
...
var PaymentElement2 = ({ fallback }) => {
  ...
  const environment = useInternalEnvironment();
  const applePay = (0, import_react13.useMemo)(() => {
  ...
  const onReady = (0, import_react13.useCallback)(() => {
...
var usePaymentElement = () => {
  ...
  const reset = (0, import_react13.useCallback)(async () => {
    if (!stripe || !elements) {
      return throwLibsMissingError();
    }
...
// node_modules/@clerk/shared/dist/chunk-BTBCV6Q5.mjs
var versionSelector = (clerkJSVersion, packageVersion = "5.74.0") => {
  if (clerkJSVersion) {
...
// node_modules/@clerk/shared/dist/chunk-SZOKD6ZZ.mjs
...
var useCustomElementPortal = (elements) => {
  ...
  const [nodes, setNodes] = (0, import_react31.useState)(initialState);
  return elements.map((el, index) => ({
    ...
    portal: () => import_react31.default.createElement(import_react31.default.Fragment, null, nodes[index] ? (0, import_react_dom.createPortal)(el.component, nodes[index]) : null)
  }));
};
